...
//       <video
//         className="w-full"
//         src="https://res.cloudinary.com/dpbuwo8ha/video/upload/v1693480576/G4C_DOC_PHASE_2_H.264_H.264_wkllm3.mp4"
//         autoPlay={isPlaying}
//         ref={videoRef}
...
//           {isPlaying ? (
//             <button
//               className="text-white hover:text-gray-300 transition-colors bg-purple-500 hover:bg-purple-600 md:h-[36px] h-[33px]  w-9 font-bold "
//               onClick={handlePlayPause}
//             >
//               <AiOutlinePause className="text-2xl ml-[5px] mb-[5px] md:mb-0" />
//             </button>
//           ) : (
//             <button
//               className="text-white hover:text-gray-300 transition-colors bg-purple-500 hover:bg-purple-600 md:h-[36px] h-[33px] w-9 font-bold "
//               onClick={handlePlayPause}
//             >
//               <BsFillPlayFill className="text-2xl ml-[5px] mb-[5px] md:mb-0" />
//             </button>
//           )}
//         </div>
//       ) : (
